<template>
  <div class="mainColumn noteColumn" :class="{fullMainColumn, updatable, editDetail}" v-if="note">
      ...
      <div class="mainColumn_body">
        <div class="dashboardWrap">
          ...
          <div class="noteEditWrap_submit noEdit">
            <button v-if="!wideScreen" @click="onEnterWideScreen()">{{$t('views.noteColumn.enterWideScreen')}}</button>
            <button v-else @click="onExitWideScreen()">{{$t('views.noteColumn.exitWideScreen')}}</button>
