<template>
  <div class="debugTool">
    <svg class="debugTool_icon" @click="shown = !shown" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="_x32_" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
      <g>
    ...
    <div class="debugTool_menu" v-show="shown">
      <div class="debugTool_menu_item" @click="activeMenu = 'URL'">URL</div>
      <div class="debugTool_menu_item" @click="activeMenu = 'CustomURLScheme'">CustomURLScheme</div>
    </div>
    <my-debug-tool-url
      v-if="activeMenu === 'URL'"
